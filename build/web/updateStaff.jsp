<%-- 
    ...
    Created on : 14 Dec, 2020, 1:21:30 AM
...
<html>
    ...
    <tr>
         <td>Type Of Staff &nbsp;:&nbsp;</td>
         <td><select name="department" required size="1">
    ...
    <tr>
        ...
        <td>Class &nbsp;:&nbsp;</td>
        <td>
            <select name="qualication" required size="1">
   ...
   <br>
        ...
        <%
            ...
            {
                con=ConnectionPro.getConnection();
                String sql="Update staff_info set name=?,father_name=?,department=?,dob=?,gender=?,mobile_no=?,email=?,presentaddress=?,permanentaddress=?,qualification=? where id="+idup;
